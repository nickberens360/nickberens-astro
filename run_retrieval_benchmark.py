...
from backend.core.app_initializer_v2 import initialize_app_v2
...
async def run_simple_benchmark():
    ...
    try:
        ...
        for i, query in enumerate(test_queries, 1):
            ...
            logger.info(f"  → Found {num_docs} docs, {has_contextual_chunks} with context, type match: {type_match_ratio:.2f}")
        ...
        print("="*60)
        print(f"System Type: Contextual Retrieval")
        ...
        for result in results:
            ...
            print(f"{query_short:<40} {result['retrieval_time']:.3f}s  {result['num_documents']:<6} {result['contextual_chunks']:<8} {result['type_match_ratio']:.3f}")
