...
def initialize_app_state() -> Tuple[Dict[str, Any], SmartIllustrationService, BaseLanguageModel]:
    ...
    indexing_llm = ChatAnthropic(model="claude-3-haiku-20240307", temperature=0.1, timeout=60.0, stop=[])
    user_query_llm = ChatAnthropic(model=AppConfig.CLAUDE_MODEL, temperature=0.1, timeout=60.0, stop=[])
