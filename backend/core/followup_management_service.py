...
class FollowUpManagementService:
        ...
        try:
            with self.db_manager.get_connection() as conn:
                ...
                if strategy == 'move' and question_count > 0:
                    ...
                    # Move questions
                    moved_count = self.db_manager.move_questions_to_category(
                    ...
                    cursor.execute(
                        "DELETE FROM followup_questions WHERE category_id = ?",
                        (category_id,)
                    )
                    ...
                    success = self.db_manager.update_followup_category(
                    ...
                    try:
                        ...
                        if action == 'delete':
                            ...
                            success = self.db_manager.update_followup_question(
                                question_id, is_active=True
                            )
                        elif action == 'deactivate':
                            success = self.db_manager.update_followup_question(
                                question_id, is_active=False
                            )
                        elif action == 'update':
                            success = self.db_manager.update_followup_question(
                                question_id,
    ...
    def reorder_questions_in_category(
        self, 
        category_id: int, 
    ...
    def search_questions(
        ...
        try:
            return self.db_manager.get_followup_questions(
    ...
    def get_categories_with_stats(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for category in categories:
                category['questions_count'] = self.db_manager.get_category_question_count(
                    category['id']
                )
    ...
    def validate_category_deletion(self, category_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            target_categories = [
                cat for cat in self.db_manager.get_followup_categories()
