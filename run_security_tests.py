...
def main():
    ...
    if args.coverage:
        coverage_args = [
            ...
            "--cov=backend.core.admin_database",
    ...
    if not args.quick:
        ...
        bandit_cmd = "python3 -m bandit -r backend/core/admin_auth.py backend/core/admin_database.py backend/routes/admin.py -f json -o security_analysis.json || true"
        subprocess.run(bandit_cmd, shell=True)

        # Check for common security issues
        security_check_cmd = "python3 -c \"import backend.core.admin_auth; import backend.core.admin_database; print('✅ Security modules import successfully')\""
